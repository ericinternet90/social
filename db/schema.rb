...
ActiveRecord::Schema.define(version: 20170330035460) do
  ...
  create_table "fp_subreddits", force: :cascade do |t|
    t.integer  "subreddit_id"
    t.integer  "facebook_page_id"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["facebook_page_id"], name: "index_fp_subreddits_on_facebook_page_id", using: :btree
    t.index ["subreddit_id"], name: "index_fp_subreddits_on_subreddit_id", using: :btree
  end
